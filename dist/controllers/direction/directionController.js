...
exports.getSubDirections = exports.getDirections = void 0;
...
// Get all directions
const getDirections = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        res.status(200).json({
            success: true,
            data: directionsData,
...
const getSubDirections = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.getSubDirections = getSubDirections;
